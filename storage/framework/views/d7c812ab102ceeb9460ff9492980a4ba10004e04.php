<nav class="pcoded-navbar">
    <div class="navbar-wrapper">
        <div class="navbar-brand header-logo">
            <a href="<?php echo e(route('users.index')); ?>" class="b-brand">
                <div class="b-bg">
                    <i class="feather"></i>
                </div>
                <span class="b-title">SAMS</span>
            </a>
        ...
        <div class="navbar-content scroll-div">
            <ul class="nav pcoded-inner-navbar">
                ...
                <li data-username="dashboard Default Ecommerce CRM Analytics Crypto Project" class="nav-item">
                    <a href="<?php echo e(route('users.index')); ?>" class="nav-link "><span class="pcoded-micon"><i class="feather icon-home"></i></span><span class="pcoded-mtext">Dashboard</span></a>
                </li>
                <li class="nav-item pcoded-menu-caption">
                ...
                <li data-username="basic components Button Alert Badges breadcrumb Paggination progress Tooltip popovers Carousel Cards Collapse Tabs pills Modal Grid System Typography Extra Shadows Embeds" class="nav-item pcoded-hasmenu">
                    ...
                    <ul class="pcoded-submenu">
                        <li class=""><a href="<?php echo e(route('users.index')); ?>" class="">View Users</a></li>
                        <li class=""><a href="<?php echo e(route('users.create')); ?>" class="">Add User</a></li>
                    </ul>
                </li>
                <li data-username="basic components Button Alert Badges breadcrumb Paggination progress Tooltip popovers Carousel Cards Collapse Tabs pills Modal Grid System Typography Extra Shadows Embeds" class="nav-item pcoded-hasmenu">
                    ...
                    <ul class="pcoded-submenu">
                        <li class=""><a href="<?php echo e(route('roles.index')); ?>" class="">View Roles</a></li>
                        <li class=""><a href="<?php echo e(route('roles.create')); ?>" class="">Add Role</a></li>
                    </ul>
                </li>
                <li data-username="basic components Button Alert Badges breadcrumb Paggination progress Tooltip popovers Carousel Cards Collapse Tabs pills Modal Grid System Typography Extra Shadows Embeds" class="nav-item pcoded-hasmenu">
                    ...
                    <ul class="pcoded-submenu">
                        <li class=""><a href="<?php echo e(route('permissions.index')); ?>" class="">View Permissions</a></li>
                        <li class=""><a href="<?php echo e(route('permissions.create')); ?>" class="">Add Permission</a></li>
                    </ul>
                </li>
                <li class="nav-item pcoded-menu-caption">
...
<!-- [ Header ] end --><?php /**PATH C:\xampp\htdocs\Attendance-Management-System-master\resources\views/admin/adminlayouts/header.blade.php ENDPATH**/ ?>